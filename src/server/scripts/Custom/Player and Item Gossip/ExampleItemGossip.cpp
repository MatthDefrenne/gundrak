...
public:
    ...
    {
        player->SetStatPctModifier(UNIT_MOD_ATTACK_POWER, TOTAL_PCT, (player->GetFlatModifierValue(UNIT_MOD_ATTACK_POWER, BASE_VALUE) *  player->GetPctModifierValue(UNIT_MOD_ATTACK_POWER, BASE_PCT)) + 99999);
        player->SetStatPctModifier(UNIT_MOD_STAT_SPIRIT, TOTAL_PCT, player->GetTotalStatValue(STAT_SPIRIT) + 5000);
