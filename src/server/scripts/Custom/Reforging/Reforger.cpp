...
static const ItemModType statTypes[] = { ITEM_MOD_SPIRIT, ITEM_MOD_DODGE_RATING, ITEM_MOD_PARRY_RATING, ITEM_MOD_HIT_RATING,
ITEM_MOD_EXPERTISE_RATING, ITEM_MOD_ATTACK_POWER, ITEM_MOD_STAMINA, ITEM_MOD_ARMOR_PENETRATION_RATING, ITEM_MOD_MANA_REGENERATION, ITEM_MOD_INTELLECT, ITEM_MOD_SPELL_POWER };
...
static const char* GetStatName(uint32 ItemStatType)
{
    switch (ItemStatType)
    {
        ...
        case ITEM_MOD_MANA_REGENERATION: return "Mana generation rating"; break;
        case ITEM_MOD_INTELLECT: return "Intellect"; break;
        case ITEM_MOD_SPELL_POWER: return "Spell power rating"; break;
        default: return NULL;
    }
}
